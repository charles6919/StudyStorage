...
{
	g_pTextureManager->AddTexture(L"GoldNumber", L"GoldNumber.png", L"../../_Images/CSH/UIImages/");
	g_pTextureManager->AddTexture(L"BlueNumber", L"BlueNumber.png", L"../../_Images/CSH/UIImages/");
	g_pTextureManager->AddTexture(L"UpperLetter", L"UpperLetter.png", L"../../_Images/CSH/UIImages/");
	g_pTextureManager->AddTexture(L"LowerLetter", L"UpperLetter.png", L"../../_Images/CSH/UIImages/");
