...
void SoundManager::MuzeOn(string key)
{
	m_ppChannel[m_mapIndex[key]]->setVolume(0.0f);
}

void SoundManager::MuzeOff(string key)
{
	m_ppChannel[m_mapIndex[key]]->setVolume(1.0f);
}
