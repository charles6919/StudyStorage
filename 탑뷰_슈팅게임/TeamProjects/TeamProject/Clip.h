...
public:
	...
	void SetStartFrame(int n) { m_nCurrFrame = n; }
	...
	{ 
		...
		{
			p->pSprite->SetBorder(b);
		}
		
	}
	
	Frame* GetFrame(int index) { return m_vecFrame[index]; }//Ãß°¡µÊ
	int GetCurrFrameIndex() { return m_nCurrFrame; }
	int GetFramevecSize() { return m_vecFrame.size(); }//Ãß°¡µÊ
