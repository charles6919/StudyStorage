...
void Physics2D_RigidBody::Update()
{
	if (!m_bKinematic)
	{
		...
		m_pTransform->SetPosition(m_pTransform->GetPosition().x + m_vForce.x * g_pTimeManager->GetDeltaTime(), m_pTransform->GetPosition().y + m_vForce.y * g_pTimeManager->GetDeltaTime());
	}
}
// ============================================================================
