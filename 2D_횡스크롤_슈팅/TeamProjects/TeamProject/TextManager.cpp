...
{
	g_pTextureManager->AddTexture(L"GoldNumber",  L"GoldNumber.png", L"../../_Images/UIImagesCSH/");
	g_pTextureManager->AddTexture(L"BlueNumber",  L"BlueNumber.png", L"../../_Images/UIImagesCSH/");
	g_pTextureManager->AddTexture(L"WhiteNumber", L"WhiteNumber.png", L"../../_Images/UIImagesCSH/");
	g_pTextureManager->AddTexture(L"UpperLetter", L"UpperLetter.png", L"../../_Images/UIImagesCSH/");
	g_pTextureManager->AddTexture(L"LowerLetter", L"UpperLetter.png", L"../../_Images/UIImagesCSH/");
	g_pTextureManager->AddTexture(L"BitText", L"BitFont_White.png", L"../../_Images/UIImagesCSH/");
