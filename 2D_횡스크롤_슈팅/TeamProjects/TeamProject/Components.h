...
public:
	...
	void TransformXAdd(float f) { position.x += f; }
	void TransformYAdd(float f) { position.y += f; }
...
public:
	...
	void SetForceX(float f) { m_vForce.x = f; }
	void SetForceY(float f) { m_vForce.y = f; }
